...
public interface MiGramaticaListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterWhile(MiGramaticaParser.WhileContext ctx);
	/**
	 * Exit a parse tree produced by the {@code While}
	 * labeled alternative in {@link MiGramaticaParser#whileStmt}.
	 * @param ctx the parse tree
	 */
	void exitWhile(MiGramaticaParser.WhileContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code CondicionVariable}
	 * labeled alternative in {@link MiGramaticaParser#condicion}.
	 * @param ctx the parse tree
	 */
	void enterCondicionVariable(MiGramaticaParser.CondicionVariableContext ctx);
	/**
	 * Exit a parse tree produced by the {@code CondicionVariable}
	 * labeled alternative in {@link MiGramaticaParser#condicion}.
	 * @param ctx the parse tree
	 */
	void exitCondicionVariable(MiGramaticaParser.CondicionVariableContext ctx);
	/**
